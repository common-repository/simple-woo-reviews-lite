...
Tags: customer reviews, woocommerce reviews, reviews, woocommerce, product reviews 
...
* Quick view popup functionality to display Product reviews with some useful stats for admin.
...
&#9658; **Product Review Reminder**: Send product review reminder notifications to the customers for reviewing their order via one click.

&#9658; **Review For Reward / Discount**: Send discount coupon to the customers for rewarding them for reviewing their ordered products.
...
= 1.0.3 =
* Fixed shortcodes rendering issues on the frontend of the plugin.
* Fixed WP admin bar editing link issues on the plugin activation.
