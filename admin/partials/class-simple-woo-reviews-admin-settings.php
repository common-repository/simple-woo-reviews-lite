    ...
    function swr_get_shortcodes_desc(){ ?>
        ...
        <div class="swr-adsec-opt-info">
            ...
            <div class="swr-shortcodes-desc">
				<div class="swr-shortcode-info">
					<div class="shortcode-title-wrap">
                		<h4><?php esc_html_e('Reviews Listing Shortcode','simple-woo-reviews') ?></h4>
						<button type="button" class="swr-copy-shortcode button"><?php esc_html_e('Copy Shortcode','simple-woo-reviews');?></button>
					</div>
				...
				<div class="swr-shortcode-info">
					...
					<div class="swr-shortcode">
                		<pre> [swr-reviews-slider title='What Our Clients Say' custom_class='custom' post_id='' orderby='title' order='ASC' num_posts=-1 layout_style='Grid' show_date='yes' icon_background_color='#ffc600' rating_color='#ffc600' main_heading_color='#444' slidesShow=3 dots='no' speed=1500 autoplay='yes' autoplaySpeed=2500 arrows='yes' pauseOnFocus='yes' pauseOnHover='yes']
                        </pre>
					</div>
				</div>
				<div class="swr-shortcode-info">
