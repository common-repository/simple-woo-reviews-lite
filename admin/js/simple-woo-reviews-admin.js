jQuery(document).ready(function($) {
    ...
    ======================================================*/
	$('.swr-copy-shortcode').on('click',function(event){
		//Prevent event default behavior
		event.preventDefault();
		let shortcode = $(this).parents('.swr-shortcode-info').find('.swr-shortcode pre').text();
		navigator.clipboard.writeText(shortcode).then(function () {
    		alert('Shortcode is copied successfully. Use CTRL + V to paste shortcode in the text editor :)');
		}, function () {
    		alert('Fail to copy shortcode. Please try again!');
		});
	});
